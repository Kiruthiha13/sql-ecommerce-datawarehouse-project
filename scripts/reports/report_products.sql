...
IF OBJECT_ID('olist_gold.report_products', 'V') IS NOT NULL
    DROP VIEW olist_gold.report_products;
GO


CREATE OR ALTER VIEW olist_gold.report_products AS
...
SELECT 
    ...
    -- Derivative flags for easy consumption
    CASE 
